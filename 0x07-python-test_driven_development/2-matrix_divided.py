...
def matrix_divided(matrix, div):
    """This function divides all elements(integers/float numbers) of a matrix by a given number

    Args:
        matrix: A list of lists (matrix)- elements can be of type integer or floats
